...
String back_default;
	...
	public String toString() {
		return "HeartGoldSoulSilver [back_default=" + back_default + ", back_female=" + back_female + ", back_shiny="
				+ back_shiny + ", back_shiny_female=" + back_shiny_female + ", front_default=" + front_default
				+ ", front_female=" + front_female + ", front_shiny=" + front_shiny + ", front_shiny_female="
				+ front_shiny_female + "]";
	}
}
