...
public class OmegaRubyAlphaSaphire {
	...
	public String toString() {
		return "OmegaRubyAlphaSaphire [front_default=" + front_default + ", front_female=" + front_female
				+ ", front_shiny=" + front_shiny + ", front_shiny_female=" + front_shiny_female + "]";
	}
